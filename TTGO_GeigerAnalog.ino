...
void setup() {
  Serial.begin(9600); // For debug/*Based on original code by juliaandwillett: https://create.arduino.cc/projecthub/juliandwillett/customizable-geiger-muller-counter-e847d1 */
